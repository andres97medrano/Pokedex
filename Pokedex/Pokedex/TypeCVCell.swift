...
class TypeCVCell: UICollectionViewCell
{
    ...
    override func awakeFromNib()
    {
        ...
        typeLabel = UILabel(frame: CGRect(x: 0, y: 2 * contentView.frame.height / 5, width: contentView.frame.width, height: 20))
        typeLabel.textAlignment = .center
        typeLabel.font = UIFont(name: "Pokemon GB", size: 12)
